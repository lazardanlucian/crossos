...
# Note: a standalone Android APK is not generated by this CMake flow.
# To test hello_world on a device, package the native target in an Android Studio app project.
```
